...
public final class SqlDdlRender {
	...
	public static String createTable(CreateTableSql s, String resolvedTable) {
		...
		for (ColumnSpec col : s.columns()) {
			...
			if (col.defaultExprOrNull() != null && !col.defaultExprOrNull().isBlank()) {
				sb.append(" DEFAULT ").append(col.defaultExprOrNull());
			}
		}
	...
	public static String alterTable(AlterTableSql s, String resolvedTable) {
		...
		if (s.dropConstraintName() != null) {
			...
			if (s.addConstraintNameOrNull() != null && !s.addConstraintNameOrNull().isBlank()) {
				sb.append("CONSTRAINT ").append(s.addConstraintNameOrNull()).append(' ');
			}
			sb.append("PRIMARY KEY (");
			appendCols(sb, s.addPrimaryKeyColumns());
			sb.append(')');
