 ...
 * @since: 1.0
 */
public class AlwaysFalseCondition implements FilterCondition {
	private static final AlwaysFalseCondition INSTANCE = new AlwaysFalseCondition();

	public static AlwaysFalseCondition getInstance() {
		return INSTANCE;
	}
