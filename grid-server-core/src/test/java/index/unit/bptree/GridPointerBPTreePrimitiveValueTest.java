 ...
 * @since: 1.0
 */
public class GridPointerBPTreePrimitiveValueTest extends AbstractGridPointerBPTreeTest {
	private int value;
	...
	public void _01_expect_equal() {
		final byte[] valueArray = SqlWireUtil.toGenericArray(5);
	...
	public void _03_expect_range() {
		final byte[] lo = SqlWireUtil.toGenericArray(2);
		final byte[] hi = SqlWireUtil.toGenericArray(6);
	...
	public void _04_expect_gt() {
		final byte[] valueArray = SqlWireUtil.toGenericArray(7);
		...
		final byte[] v8 = SqlWireUtil.toGenericArray(8);
		Assertions.assertTrue(matchAnyPointers(result.getPointers(), v8));

		final byte[] v9 = SqlWireUtil.toGenericArray(9);
	...
	public void _08_expect_not_exists() {
		final byte[] valueArray = SqlWireUtil.toGenericArray(15);
		final IndexOperationResult result = laxTree.searchEq(new SingleTreeKey(valueArray));
	...
	public void _09_expect_delete_and_not_exists() {
		final byte[] valueArray = SqlWireUtil.toGenericArray(9);
