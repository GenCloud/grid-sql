...
public class SimplifiedSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "SELECT", "EXPLAIN", "ANALYZE", "INSERT", 
			"UPSERT", "INTO", "VALUES", "DELETE", "UPDATE", "SET", "REMOTE_DIRTY", 
			"MERGE", "CONFLICT", "DO", "NOTHING", "MATCHED", "CREATE", "DROP", "ALTER", 
			"ADD", "COLUMN", "SCHEMA", "TABLE", "VIEW", "MATERIALIZED", "REFRESH", 
			"FUNCTION", "TRIGGER", "RETURNS", "CLASS", "METHOD", "BEFORE", "AFTER", 
			"EACH", "WITH", "RECURSIVE", "UNION", "INTERSECT", "EXCEPT", "ALL", "INDEX", 
			"UNIQUE", "BITMAP", "PRIMARY", "KEY", "IF", "EXISTS", "NOT", "NULL", 
			"FROM", "FOR", "SKIP_KW", "LOCKED", "RETURNING", "WHERE", "GROUP", "HAVING", 
			"ORDER", "BY", "LIMIT", "OFFSET", "DISTINCT", "COUNT", "SUM", "AVG", 
			"MIN", "MAX", "CONCAT", "CAST", "UUID_TYPE", "DATE_TYPE", "TIME_TYPE", 
			"TIMESTAMP_TYPE", "TIMESTAMPTZ_TYPE", "CASE", "WHEN", "THEN", "ELSE", 
			"END", "OVER", "WINDOW", "PARTITION", "ROW_NUMBER", "ROW", "RANK", "DENSE_RANK", 
			"LAG", "LEAD", "JOIN", "INNER", "LEFT", "RIGHT", "FULL", "OUTER", "ON", 
			"RESTRICT", "CASCADE", "AUTHORIZATION", "FOREIGN", "REFERENCES", "CONSTRAINT", 
			"CHECK", "SEQUENCE", "SERIAL", "BIGSERIAL", "GENERATED", "DEFAULT", "IDENTITY", 
	...
	public static final String _serializedATN =
		...
		"\u00a5\u014b\u00a6\u014d\u00a7\u014f\u00a8\u0151\u00a9\u0153\u00aa\u0001"+
		"\u0000\u001f\u0002\u0000SSss\u0002\u0000EEee\u0002\u0000LLll\u0002\u0000"+
		"CCcc\u0002\u0000TTtt\u0002\u0000XXxx\u0002\u0000PPpp\u0002\u0000AAaa\u0002"+
		"\u0000IIii\u0002\u0000NNnn\u0002\u0000YYyy\u0002\u0000ZZzz\u0002\u0000"+
		"RRrr\u0002\u0000UUuu\u0002\u0000OOoo\u0002\u0000VVvv\u0002\u0000DDdd\u0002"+
		"\u0000MMmm\u0002\u0000GGgg\u0002\u0000FFff\u0002\u0000HHhh\u0002\u0000"+
		"BBbb\u0002\u0000WWww\u0002\u0000QQqq\u0002\u0000KKkk\u0002\u0000JJjj\u0003"+
		"\u0000AZ__az\u0004\u000009AZ__az\u0001\u000009\u0001\u0000\'\'\u0003\u0000"+
		"\t\n\r\r  \u0586\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003\u0001"+
		"\u0000\u0000\u0000\u0000\u0005\u0001\u0000\u0000\u0000\u0000\u0007\u0001"+
		"\u0000\u0000\u0000\u0000\t\u0001\u0000\u0000\u0000\u0000\u000b\u0001\u0000"+
