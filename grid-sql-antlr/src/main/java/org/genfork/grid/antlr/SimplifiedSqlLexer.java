...
public class SimplifiedSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"UPSERT", "INTO", "VALUES", "DELETE", "TRUNCATE", "UPDATE", "SET", "REMOTE_DIRTY", 
			"MERGE", "CONFLICT", "DO", "NOTHING", "MATCHED", "EXCLUDED", "CREATE", 
			"DROP", "ALTER", "ADD", "COLUMN", "SCHEMA", "TABLE", "VIEW", "MATERIALIZED", 
