...
Старый путь «WAL поверх карты» и двойная запись компактных снимков удалены. Источник правды при включённой записи на диск — OpLog и запечатанные файлы, а карта в памяти — ускоритель.
