...
### Чтение с реплики (выключено по умолчанию на сервере)

Методика: [чтение с реплики](replica-reads.md).

Запись и открытая TX остаются на URL пишущего. Autocommit-чтения — на каналы к репликам:
