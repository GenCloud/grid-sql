...
# Newest history.edn under store whose parent dir name matches needle (register|append).
find_history() {
  local needle="$1"
  ...
  # Prefer directories whose name contains the workload tag (e.g. jamoa-orchid-register-nochao).
  local hit
